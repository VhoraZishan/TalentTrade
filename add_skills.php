                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12">
                            ...
                            <div class="row">
                                ...
                                <div class="form-item w-100">
                                    ...
                                    <input type="file" name="skill_image" id="skillImage" class="form-control" accept="image/*" required>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            ?>
                                ...
                                <td>
  <a href="edit_skills.php?skill_id=<?php echo $row['skill_id']; ?>" class="btn btn-primary" style="color:white; margin:3px;">Edit</a>
...
<div class="modal" id="deleteModal<?php echo $row['skill_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="delete_skill.php?skill_id=<?php echo $row['skill_id']; ?>" class="btn btn-danger">Delete</a>
      </div>
    </div>
  </div>
</div>
